...
import org.linthaal.genai.services.{HuggingFaceInferenceEndpointsService, OpenAIService, Service}
...
object APIJsonFormats {
  ...
  implicit val primeKGQAReq: RootJsonFormat[PrimeKGQAReq] = jsonFormat1(PrimeKGQAReq.apply)

  implicit val primeKGAnswer: RootJsonFormat[PrimeKGAnswer] = jsonFormat1(PrimeKGAnswer.apply)
