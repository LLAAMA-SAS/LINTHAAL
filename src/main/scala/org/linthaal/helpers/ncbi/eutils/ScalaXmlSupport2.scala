...
trait ScalaXmlSupport2 {
  ...
  /** Provides a SAXParser for the NodeSeqUnmarshaller to use. Override to provide a custom SAXParser implementation. Will be called once
    * for for every request to be unmarshalled. The default implementation calls `ScalaXmlSupport2.createSaferSAXParser`.
    */
